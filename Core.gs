...
const CONFIG = {
  ...
  FEATURE_FLAGS: {
    ...
    testingTab: true,          // true = Testing Status tab button is clickable; false = disabled (greyed out)
...
// Maps Column E (Application name from Jira_Cloud_Directory.xlsx) → Column C (Team name).
// Empty string value means Column C was blank — resolution falls back to using the Column E value itself.
const APPLICATION_TO_TEAM_MAPPING = {
  'CloudBSS':                                                     'NC Cloud',
  'Service Address Selection MFE':                                'FUSE',
  'Appointment Selection MFE':                                    'FUSE',
  'Cross Sell MFE':                                               'FUSE',
  'Commerce Shell':                                               'FUSE',
  'Commerce Session API':                                         'FUSE',
  'Auth Status API':                                              'FUSE',
  'Checkout Shell':                                               'Checkout',
  'Hardware Selection MFE':                                       'FUSE',
  'Send Quote MFE':                                               'FUSE',
  'Manage Shell':                                                 'My TELUS',
  'Add On Selection MFE (V2)':                                    'C3X',
  'Hardware Shell':                                               'FUSE',
  'Cancel / Renew MFE':                                           'My TELUS',
  'Manage Licenses MFE':                                          'FUSE',
  'Hardware Return MFE':                                          'FUSE',
  'Payment MFE':                                                  'Checkout',
  'Send Communication MFE':                                       '',
  'Product Subscription Overview (PSO) MFE':                     'FUSE',
  'Pro Install MFE':                                              'C3X',
  'Credit Assessment MFE':                                        'C3X',
  'Product Type Selection MFE':                                   'C3X',
  'Promotion Selection MFE':                                      '',
  'Device Selection MFE':                                         'C3X',
  'Phone Number Selection MFE':                                   'C3X',
  'Subscriber Information MFE':                                   'C3X',
  'Sales Summary MFE':                                            'C3X',
  'Order Summary MFE':                                            'C3X',
  'Rate Plan Selection MFE':                                      'Channel Sales Experience',
  'Port-In MFE':                                                  'Channel Sales Experience',
  'Add On Selection MFE':                                         'Channel Sales Experience',
  'Device Selection (Sim) MFE':                                   'C3X',
  'Coupon Code MFE':                                              'C3X',
  'Package Selection MFE':                                        'C3X',
  'Create Account MFE':                                           'C3X',
  'Create Customer MFE':                                          'C3X',
  'Order Status MFE':                                             '',
  'Digital Signature MFE':                                        '',
  'Universal MFE + Shell (UOST)':                                 'Galaxy',
  'Spatial Net':                                                  'Spatial Net',
  'CAMP':                                                         'Mediation',
  'CMF':                                                          'Mediation',
  'OutCollect':                                                   'Mediation',
  'Fraud Engine':                                                 'Precision Fraud',
  'customer-api':                                                 'My TELUS',
  'NBA MFE':                                                      'Analytics Implementation',
  'Product Qualification':                                        'C30C',
  'EOM':                                                          'Offer Management',
  'GEM':                                                          'GEM',
  ...
  'C30C':                                                         'C30C',
  'AMS':                                                          '',
  'AES':                                                          'TV Activation (OPUS)',
  'SSNS':                                                         '',
  'PaaS':                                                         '',
  'SWORM':                                                        '',
  'My TELUS Billing UI':                                          'Dope Jackalopes',
  'My TELUS Payments UI':                                         'Dope Jackalopes',
  'My TELUS Appointments UI':                                     'Neo Titans',
  'My TELUS Purple Manage Apps':                                  'Neo Titans',
  'My TELUS Overview UI':                                         'Huffle Puffins',
  'overview-api':                                                 'Cool Beans',
  'My TELUS Navigation':                                          'My TELUS Navigation',
  'My TELUS App (Expo - Front end)':                              'My T App',
  'My TELUS App (BFF)':                                           'My T App',
  'My TELUS Plans & Devices':                                     '',
  'My TELUS B2B WLN':                                             'Cool Beans',
  'My TELUS B2B WLS':                                             'Fast & Furious',
  'TechHub':                                                      '',
  'WFM':                                                          '',
  'Subscriber DB':                                                '',
  'Contact Engine':                                               '',
  'Enterprise Communication Platform (ECP)':                      '',
  'Channel Dashboard':                                            'Channel Dashboard',
  'SubMgmt':                                                      '',
  'Bundle Qualification API':                                     'Enterprise TMF APIs',
  'TMF 702 SharedONT Task API':                                   'Enterprise TMF APIs',
  'TMF-648':                                                      'Enterprise TMF APIs',
  'Market Resolver':                                              '',
  'WFM Sales Force Scheduler':                                    '',
  'Purple Shop & Buy':                                            '',
  'UDE Checkout (purple /yellow)':                                '',
  'Casa Partner':                                                 '',
  'Casa TBS':                                                     '',
  'Casa CE':                                                      'CASA',
  'EPC?????':                                                     '',
  'EPC':                                                          '',
  'CES':                                                          'CES',
  'Subscription Management':                                      'Billing Team',
  'Billing API':                                                  'Billing Team',
  'Enterprise Account Management APIs':                           'Billing Team',
  'Kenan':                                                        'Calculations, Accounts Receivables, Payments and Settlements',
  'EPS - Enterprise Payment Systems':                             'EPS - Enterprise Payment Systems',
  'Phone Number Inventory, Knowbility, Work order Batch Triggers': 'Facilities and Resource Management',
  'Datahub Platform':                                             'Enterprise Analytics Platform',
  'Datahub Tools':                                                'Analytics Tools 1',
  'Home Device Discovery Platform (Replaces HDM Team)':           'Customer Data and Service Assurance',
  'Bill Presentment & Analytics':                                 'Bill Genetix',
  'Knowbility Decommission':                                      'DBE Platforms',
  'Knowbility to GCP':                                            'DBE Platforms',
  'Wonder Women':                                                 'DC Comics',
  'Black Widow':                                                  'Marvel',
  'TMF-645 (Service Qual API)':                                   '',
  'Authentication MFE':                                           '',
};
